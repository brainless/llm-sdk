...
pub fn get_all_models() -> Vec<ModelMetadata> {
    vec![
        ...
        ModelMetadata {
            ...
            model_id: models::cerebras::GPT_OSS_120B_ID,
            name: models::cerebras::GPT_OSS_120B_NAME,
            context_length: 131_072,
            supports_streaming: true,
            supports_tool_calling: true,
            supports_vision: false,
            supports_reasoning: true,
            input_cost_per_token: Some(0.00000035),
            output_cost_per_token: Some(0.00000075),
            default_temperature: None,
            default_max_tokens: Some(40_960),
            default_thinking_level: None,
        },
        ModelMetadata {
            provider: providers::CEREBRAS,
            model_id: models::cerebras::QWEN_3_8_27B_ID,
            name: models::cerebras::QWEN_3_8_27B_NAME,
        ...
        ModelMetadata {
            ...
            model_id: models::xiaomi::MIMO_V2_6_PRO_ID,
            name: models::xiaomi::MIMO_V2_6_PRO_NAME,
        ...
        ModelMetadata {
            provider: providers::XIAOMI,
            model_id: models::xiaomi::MIMO_V2_6_FLASH_ID,
            name: models::xiaomi::MIMO_V2_6_FLASH_NAME,
            context_length: 1_000_000,
            supports_streaming: true,
            supports_tool_calling: true,
            supports_vision: true,
